...
@interface XFOrderDetailsAddressCell : UITableViewCell
/// 提货点地址
@property (weak, nonatomic) IBOutlet UILabel *shopAddressLabel;
/// 提货点
@property (weak, nonatomic) IBOutlet UILabel *shopPointLabel;
/// 提货点电话
@property (weak, nonatomic) IBOutlet UILabel *shopPhoneNumberLabel;
/// 提货人
